                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          'Monitor your menstrual cycle to view your current phase and track expected mood changes.',
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .labelLarge
                                              .override(
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0, 16, 0, 0),
                                          child: Text(
                                            'Receive specific exercise recommendations on which physical activities to perform and which to avoid.',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .labelLarge
                                                .override(
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0, 16, 0, 0),
                                          child: Text(
                                            'Access dietary guidelines that indicate the appropriate foods to consume or limit during your cycle.',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .labelLarge
                                                .override(
